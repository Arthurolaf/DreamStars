...
from PySide6.QtWidgets import (QApplication, QDialog, QDockWidget,
        QFileDialog, QListWidget, QMainWindow, QMessageBox, QTextEdit, QGraphicsScene, QGraphicsView)
...
class MainWindow(QMainWindow):
    ...
    def create_dock_windows(self):
        ...
        scene.views
        model1 = QGraphicsView("map", scene)

        model1.setAllowedAreas(Qt.LeftDockWidgetArea | Qt.RightDockWidgetArea)
